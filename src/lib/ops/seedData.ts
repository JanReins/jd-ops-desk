...
const METKA_ENTITIES: { name: string; tax: string; owner: string }[] = [
  { name: "Alligator Bess Holdings Pty Ltd (Group)", tax: "Confirm registration", owner: "Jan" },
  { name: "Carinya BESS Holdings Pty Ltd (Group)", tax: "Confirm registration", owner: "Jan" },
  { name: "Denhun Holdco Pty Ltd (Group)", tax: "Confirm registration", owner: "Jan" },
  { name: "Denman Bess Trust", tax: "Confirm registration", owner: "Jan" },
  { name: "Denman Bess Holdings Pty Ltd", tax: "Confirm registration", owner: "Jan" },
  { name: "Emu Park Energy Holdings Pty Ltd (Group)", tax: "GST & Deferred GST", owner: "Jan" },
  { name: "Hay Solar Farm Holdings Pty Ltd (Group)", tax: "GST", owner: "Jan" },
  {
    name: "M Renewables Australia Developments Pty Ltd",
    tax: "GST, Deferred GST & PAYGI quarterly",
    owner: "Jan",
  },
  { name: "Metlen Australia Finco Pty Ltd", tax: "GST", owner: "Jan" },
  { name: "Metlen Australia Services Pty Ltd", tax: "GST", owner: "Jan" },
  { name: "Mettransfers Pty Ltd", tax: "GST", owner: "Jan" },
  { name: "Mavis Solar Farm Australia Holdings (Group)", tax: "GST", owner: "Jovelyn" },
  { name: "Moama SF Holdco Pty Ltd (Group)", tax: "GST", owner: "Jovelyn" },
  { name: "Moura Solar Farm Holdings Pty Ltd (Group)", tax: "GST & PAYGW (monthly)", owner: "Jovelyn" },
  { name: "Munna Creek Solar Farm Hold Co Pty Ltd (Group)", tax: "GST & PAYGW (monthly)", owner: "Jovelyn" },
  { name: "Polldale SF Holdings Pty Ltd (Group)", tax: "GST", owner: "Jovelyn" },
  { name: "Plains SF No1 Pty Ltd", tax: "GST", owner: "Jovelyn" },
  { name: "Terranova Asset Trust (Group)", tax: "GST", owner: "Jovelyn" },
  { name: "Upper Hunter SF Holdco (Group)", tax: "GST", owner: "Jovelyn" },
  { name: "Wyalong Solar Farm Holdings Pty Ltd (Group)", tax: "GST & PAYGW (monthly)", owner: "Jovelyn" },
];
